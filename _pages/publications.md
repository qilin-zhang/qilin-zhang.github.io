...
Yunfeng Wang, Wengang Zhou, Qilin Zhang, Houqiang Li, "Convolutional Neural Networks with Generalized Attentional Pooling for Action Recognition", IEEE International Conference on Visual Communications and Image Processing (VCIP), December 2018. (oral presentation) [[PDF]](https://qilin-zhang.github.io/_pages/pdfs/Convolutional_Neural_Networks_with_Generalized_Attentional_Pooling_for_Action_Recognition.pdf?raw=true)
